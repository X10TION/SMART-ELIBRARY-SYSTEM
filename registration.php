...
<head>
    <meta charset="UTF-8">
    <title>Smart E-library Management System</title>
    ...
    <div class="registration">
        <div class="reg-wrapper">
            <div class="reg-header text-center">
                <h2>Smart E-library Management System</h2>
            </div>
            <div class="gap-40"></div>
            <div class="reg-body">
                <h4 style="text-align: center; margin-bottom: 25px;">Admin Registration</h4>
