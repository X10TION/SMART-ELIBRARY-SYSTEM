				...
				<div class="row counterup">
					...
					<div class="col-md-3 col-sm-3 col-xs-12 control">
						<div class="box box4">
							...
							<div class="text">
								...
								<h3><span class="counter"><h1>4</h1></span></h3>
								<h4><a href="fine.php">Multimiadia</a></h4>
							</div>
						</div>
					</div>
					<div class="col-md-3 col-sm-3 col-xs-12 control">
						<div class="box box3">
							...
							<div class="text">
								<h4 class="mt-20"><a href="display-books.php">Resources</a></h4>
							</div>
						</div>
					</div>
					<div class="col-md-3 col-sm-3 col-xs-12 control">
					...
					<div class="col-md-3 col-sm-3 col-xs-12 control">
						<div class="box box2">
							...
							<div class="text">
								<h4 class="mt-10"><a href="requested-books.php">Recommended Books</a></h4>
