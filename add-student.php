				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="right text-right">
							...
							<span class="disabled">Add SubAdmin</span>
						</div>
					</div>
				</div>
				<div class="addUser">
					...
					<div class="reg-body user-content">
                        ...
                        <?php endif ?>
                        <h4 style="text-align: center; margin-bottom: 25px;">Sub Admin Registration</h4>
                        <form action="" class="form-inline" method="post">
                            ...
                            <div class="form-group">
                                <label for="regno">SP No <span>*</span></label>
                                <input type="text" class="form-control custom" placeholder="SP No" name="regno"/>
                            </div>
                            ...
                            <div class="submit">
                                <input type="submit" value="Add SubAdmin" name="submit" class="btn change text-center">
                            </div>
                        </form>
