				...
				<div class="sidebar-menu">
	                ...
	                <ul>
	                    ...
	                    <li class="menu <?php if($page=='sinfo'){ echo 'active';} ?>">
      						<a href="all-student-info.php"><i class="fas fa-desktop"></i>all studentS information</a>
    					</li>
    					<li class="menu <?php if($page=='tinfo'){ echo 'active';} ?>">
      						<a href="all-teacher-info.php"><i class="fas fa-desktop"></i>all STAFF information</a>
    					</li>
    					<li class="menu">
    						<a href="http://localhost/matomo/index.php?module=CoreHome&action=index&idSite=1&period=day&date=yesterday&showtitle=1&random=8455#?idSite=1&period=day&date=2021-09-21&segment=&category=Dashboard_Dashboard&subcategory=1">analytic</a>
    					</li>
<li class="menu">
      						<a href="http://localhost/matomo/index.php?module=CoreHome&action=index&idSite=1&period=day&date=yesterday&showtitle=1&random=8455#?idSite=1&period=day&date=2021-09-21&segment=&category=Dashboard_Dashboard&subcategory=1">User Behaviour</a>
    					</li>
					
    					<li class="menu menu-toggle2">
      						<a href="#"><i class="fas fa-location-arrow"></i>manage resources <span class="fa fa-chevron-down"></span></a>
      						<ul class="menus2">
      							<li><a href="add-book.php">add book</a></li>
								  <li><a href="journal.php">journal</a></li>
								  <li><a href="thesis.php">thesis</a></li>
								   <li><a href="SEMS\multimedia.php">Multimedia</a></li>
    					...
    					<li class="menu menu-toggle4">
      						...
      						<ul class="menus4">
      							...
      							<li><a href="send-to-teacher.php">send to staff</a></li>
      						</ul>
    					</li>
    				</ul>
				</div>
			...
			<div class="content">
				<div class="inner">
					<div class="heading text-center">
						<h3>Smart E-library Management System</h3>
					</div>
