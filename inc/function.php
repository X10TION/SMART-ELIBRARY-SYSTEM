...
//            }
		...
		$sql_u= mysqli_query($link,"select * from lib_registration where username= '$username'");
		$sql_e= mysqli_query($link,"select * from lib_registration where email= '$email'");
		$sql_p= mysqli_query($link,"select * from lib_registration where phone= '$phone'");
		$sql_r= mysqli_query($link,"select * from lib_registration where regno= '$regno'");
